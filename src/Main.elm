...
availableRecipes = [
    ...
    { id = "bunny-day-wand", source = [Other "Celeste"], name = "Bunny Day Wand" },
    ...
    { id = "ice-wand", source = [Other "Celeste"], name = "Ice Wand" },
    ...
    { id = "lunar-rover", source = [Other "Celeste"], name = "Lunar Rover" },
    ...
    { id = "mushroom-wand", source = [Other "Celeste"], name = "Mushroom Wand" },
